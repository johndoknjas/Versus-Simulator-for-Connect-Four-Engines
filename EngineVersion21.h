                                    ...
                                    bool starting_new_game)
{
    ...
    while (depth_limit < 8 && !find_duplicate_in_TT(pt).is_evaluation_indisputable && pt->number_of_pieces + depth_limit <= 43)
    {
